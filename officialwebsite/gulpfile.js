...
gulp.task("css",function(){
	gulp.src(["src/public/less/*.less","!src/public/less/base.less"]).pipe(less()).pipe(cssmin()).pipe(gulp.dest("dest/public/css"));
...
gulp.task("js",function(){
	...
	gulp.src(["src/public/js/*.js","!src/public/js/jquery.min.js"]).pipe(jsmin(jsData)).pipe(gulp.dest("dest/public/js"));
...
gulp.task("html",function(){
	...
	gulp.src("src/index.html").pipe(htmlmin(htmlData)).pipe(gulp.dest("dest"));
...
gulp.task("htmlReload",function(){
	gulp.src("dest/index.html").pipe(connect.reload());
	gulp.src("dest/html/*.html").pipe(connect.reload());
});

gulp.task("watch",function(){
	gulp.watch("src/index.html",["html","htmlReload"]);
